        ...
        public function panel_field_content( $field ) {
            ...
            switch( $field['type'] ) {
                ...
                case 'datepicker':
	                ...
	                if( empty( $value['mysql_date'] ) ){
		                $value['mysql_date'] = date( 'Y-m-d' );
	                }

	                $echo  = "<input type='text' id='{$id}_date' name='{$name}[date]' value='{$value['date']}' class='medium-text code panel-datepicker yith-panel-datepicker' colorpicker='" . __( 'Select a date', 'yith-topbar-countdown' ) . "' /> - ";
	                $echo .= "<input type='text' id='{$id}_hh' name='{$name}[hh]' value='{$value['hh']}' class='small-text code' colorpicker='" . __( 'Hours', 'yith-topbar-countdown' ) . "' /> : ";
	                $echo .= "<input type='text' id='{$id}_mm' name='{$name}[mm]' value='{$value['mm']}' class='small-text code' colorpicker='" . __( 'Minutes', 'yith-topbar-countdown' ) . "' /> : ";
	                $echo .= "<input type='text' id='{$id}_ss' name='{$name}[ss]' value='{$value['ss']}' class='small-text code' colorpicker='" . __( 'Minutes', 'yith-topbar-countdown' ) . "' />";
	                $echo .= "<input type='hidden' id='{$id}_mysql_date' name='{$name}[mysql_date]' value='{$value['mysql_date']}' class='yith_mysql_date' />";
